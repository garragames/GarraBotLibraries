...
#include "GarraBotHumanoid.h"

////////////////////////////////////////////////////////////////////////////

///////////////////////////////////////////////////////
void GarraBotHumanoid::initHUMANOID(int YL, int YR, int RL, int RR,int LA, int RA, bool load_calibration, int NoiseSensor, int Buzzer, int USTrigger, int USEcho) {
  isHUMANOID = true;
  servo_pins[0] = YL;
  servo_pins[1] = YR;
  servo_pins[2] = RL;
...
//////////////////////////////////////////////////////////
void GarraBotHumanoid::initMATRIX(int DIN, int CS, int CLK, int rotate){
ledmatrix.init( DIN, CS, CLK, 1, rotate);   // set up Matrix display
}
void GarraBotHumanoid::matrixIntensity(int intensity){
ledmatrix.setIntensity(intensity);
}
void GarraBotHumanoid::initBatLevel(int batteryPIN){
...
///////////////////////////////////////////////////////////////////
void GarraBotHumanoid::attachServos(){
...
void GarraBotHumanoid::detachServos(){
...
//-- OSCILLATORS TRIMS ------------------------------------------//
///////////////////////////////////////////////////////////////////
void GarraBotHumanoid::setTrims(int YL, int YR, int RL, int RR, int LA, int RA) {
  servo[0].SetTrim(YL);
  servo[1].SetTrim(YR);
  servo[2].SetTrim(RL);
  servo[3].SetTrim(RR);
...
void GarraBotHumanoid::saveTrimsOnEEPROM() {
...
///////////////////////////////////////////////////////////////////
void GarraBotHumanoid::_moveServos(int time, int  servo_target[]) {
...
void GarraBotHumanoid::oscillateServos(int A[6], int O[6], int T, double phase_diff[6], float cycle=1){
...
void GarraBotHumanoid::_execute(int A[6], int O[6], int T, double phase_diff[6], float steps = 1.0){
...
bool GarraBotHumanoid::getRestState(){

    return isGarraBotResting;
}

void GarraBotHumanoid::setRestState(bool state){
...
//--    T: Period
//---------------------------------------------------------
void GarraBotHumanoid::jump(float steps, int T){
...
//---------------------------------------------------------
void GarraBotHumanoid::walk(float steps, int T, int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::turn(float steps, int T, int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::bend (int steps, int T, int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::shakeLeg (int steps,int T,int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::updown(float steps, int T, int h){
...
//---------------------------------------------------------
//-- GarraBot movement: Hands up

//---------------------------------------------------------

void GarraBotHumanoid::handsup(){
...
///////////////////////////////////////////////////
void GarraBotHumanoid::handwave(int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::swing(float steps, int T, int h){
...
//--     h : Amount of swing (from 0 to 50 aprox)
//---------------------------------------------------------
void GarraBotHumanoid::tiptoeSwing(float steps, int T, int h){
...
//---------------------------------------------------------
void GarraBotHumanoid::jitter(float steps, int T, int h){
...
//---------------------------------------------------------
void GarraBotHumanoid::ascendingTurn(float steps, int T, int h){
...
//--    dir: Direction: LEFT / RIGHT
//---------------------------------------------------------
void GarraBotHumanoid::moonwalker(float steps, int T, int h, int dir){
...
//--     dir:  Direction: LEFT / RIGHT
//-----------------------------------------------------------
void GarraBotHumanoid::crusaito(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
void GarraBotHumanoid::flapping(float steps, int T, int h, int dir){
...
//---------------------------------------------------------
float GarraBotHumanoid::getDistance(){
...
//---------------------------------------------------------
double GarraBotHumanoid::getBatteryLevel(){
...
double GarraBotHumanoid::getBatteryVoltage(){
...
//-- MOUTHS & ANIMATIONS ----------------------------------------//
///////////////////////////////////////////////////////////////////
void GarraBotHumanoid::setLed(byte X, byte Y, byte value){
  ledmatrix.setDot( X,  Y, value);
}


// EXAMPLE putAnimationMouth(dreamMouth,0);
void GarraBotHumanoid::putAnimationMouth(unsigned long int aniMouth, int index){
...
void GarraBotHumanoid::putMouth(unsigned long int mouth, bool predefined){
  if (predefined){
...
void GarraBotHumanoid::clearMouth(){

  ledmatrix.clearMatrix();
}
// // limited characters are : CAPITALS A to Z   NUMBERS 0 to 9    'SPACE'  : ; < >  = @ 
void GarraBotHumanoid::writeText(const char * s, byte scrollspeed){
 int a ;
 int b ;
  for(a = 0; s[a] != '\0'; a++){
    b = a +1 ;
...
void GarraBotHumanoid::_tone (float noteFrequency, long noteDuration, int silentDuration){
    ...
    // delay(500);
      ...
      TimerFreeTone(GarraBotHumanoid::pinBuzzer, noteFrequency, noteDuration);
...
void GarraBotHumanoid::bendTones (float initFrequency, float finalFrequency, float prop, long noteDuration, int silentDuration){
...
void GarraBotHumanoid::sing(int songName){
  switch(songName){
...
void GarraBotHumanoid::playGesture(int gesture){
